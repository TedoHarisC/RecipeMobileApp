...
mixin _$CategoryState {
 ...
 bool get isLoading; BlocStatus get status; List<CategoryEntity> get categories; Failure? get failure;
...
@override
int get hashCode => Object.hash(runtimeType,isLoading,status,const DeepCollectionEquality().hash(categories),failure);

@override
String toString() {
  return 'CategoryState(isLoading: $isLoading, status: $status, categories: $categories, failure: $failure)';
}
...
@useResult
$Res call({
 bool isLoading, BlocStatus status, List<CategoryEntity> categories, Failure? failure
});
...
/// Create a copy of CategoryState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? isLoading = null,Object? status = null,Object? categories = null,Object? failure = freezed,}) {
  return _then(_self.copyWith(
isLoading: null == isLoading ? _self.isLoading : isLoading // ignore: cast_nullable_to_non_nullable
as bool,status: null == status ? _self.status : status // ignore: cast_nullable_to_non_nullable
as BlocStatus,categories: null == categories ? _self.categories : categories // ignore: cast_nullable_to_non_nullable
as List<CategoryEntity>,failure: freezed == failure ? _self.failure : failure // ignore: cast_nullable_to_non_nullable
as Failure?,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( bool isLoading,  BlocStatus status,  List<CategoryEntity> categories,  Failure? failure)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CategoryState() when $default != null:
return $default(_that.isLoading,_that.status,_that.categories,_that.failure);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( bool isLoading,  BlocStatus status,  List<CategoryEntity> categories,  Failure? failure)  $default,) {final _that = this;
switch (_that) {
case _CategoryState():
return $default(_that.isLoading,_that.status,_that.categories,_that.failure);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( bool isLoading,  BlocStatus status,  List<CategoryEntity> categories,  Failure? failure)?  $default,) {final _that = this;
switch (_that) {
case _CategoryState() when $default != null:
return $default(_that.isLoading,_that.status,_that.categories,_that.failure);case _:
  return null;
...
class _CategoryState implements CategoryState {
  const _CategoryState({this.isLoading = false, this.status = BlocStatus.initial, final  List<CategoryEntity> categories = const [], this.failure = null}): _categories = categories;
...
@override
int get hashCode => Object.hash(runtimeType,isLoading,status,const DeepCollectionEquality().hash(_categories),failure);
...
/// Create a copy of CategoryState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? isLoading = null,Object? status = null,Object? categories = null,Object? failure = freezed,}) {
  return _then(_CategoryState(
isLoading: null == isLoading ? _self.isLoading : isLoading // ignore: cast_nullable_to_non_nullable
as bool,status: null == status ? _self.status : status // ignore: cast_nullable_to_non_nullable
as BlocStatus,categories: null == categories ? _self._categories : categories // ignore: cast_nullable_to_non_nullable
as List<CategoryEntity>,failure: freezed == failure ? _self.failure : failure // ignore: cast_nullable_to_non_nullable
as Failure?,
  ));
}
